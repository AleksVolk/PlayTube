                ...
                on: {
                    init: () => {
                        ...
                        heroSlides.forEach((slide => {
                            const activeImageUrl = slide.querySelector(".hero__image").getAttribute("src");
                            const activeBg = slide.querySelector(".slide-hero__bg img");
                            activeBg.setAttribute("src", `${activeImageUrl}`);
                        }));
                    }
                }
            });
